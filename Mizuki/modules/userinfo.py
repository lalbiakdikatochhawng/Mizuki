...
from Mizuki import telethn as SaitamaTelethonClient
...
from Mizuki.modules.sql.afk_sql import check_afk_status, is_afk
...
def get_id(update: Update, context: CallbackContext):
    ...
    if user_id:
        ...
        if chat.type == "private":
            msg.reply_text(
                f"I id chu <code>{chat.id}</code>.", parse_mode=ParseMode.HTML
            )
